...
- [ ] Specification-First Design: Feature fully specified before implementation
- [ ] Instruction-Based Agent Architecture: Agent defined by markdown instruction files
